...
namespace MSBank.Data.Migrations
{
    ...
    [Migration("20220113102122_moved dbcontext")]
    partial class moveddbcontext
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSBank.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("MSBank.Models.Card", b =>
                {
            ...
            modelBuilder.Entity("MSBank.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("MSBank.Models.Disposition", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MSBank.Models.Loan", b =>
                {
            ...
            modelBuilder.Entity("MSBank.Models.PermenentOrder", b =>
                {
            ...
            modelBuilder.Entity("MSBank.Models.Transaction", b =>
                {
            ...
            modelBuilder.Entity("MSBank.Models.User", b =>
                {
            ...
            modelBuilder.Entity("MSBank.Models.Card", b =>
                {
                    b.HasOne("MSBank.Models.Disposition", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("MSBank.Models.Disposition", b =>
                {
                    b.HasOne("MSBank.Models.Account", "Account")
                        .WithMany("Dispositions")
                        .HasForeignKey("AccountId")
                        .IsRequired()
                        .HasConstraintName("FK_Dispositions_Accounts");

                    b.HasOne("MSBank.Models.Customer", "Customer")
                        .WithMany("Dispositions")
            ...
            modelBuilder.Entity("MSBank.Models.Transaction", b =>
                {
                    b.HasOne("MSBank.Models.Account", "AccountNavigation")
